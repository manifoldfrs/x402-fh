...
#### Nevermined Facilitator

* **Supports**: `eip155:8453` (Base), `eip155:84532` (Base Sepolia)
* **Notes**: AI agent payment verification and settlement. Supports ERC-20 and ERC-1155 assets.
* **URL**: https://api.live.nevermined.app/api/v1/

#### xEcho Facilitator

* **Supports**: `eip155:8453` (Base)
* **Notes**: Implements on-chain settlement callbacks for pay-to-earn and outcome-based payment scenarios. Supports ERC-20 tokens.
* **URL**: https://facilitator.xechoai.xyz
...
| Nevermined      | `eip155:8453`, `eip155:84532`                      | Yes               | None            |
| xEcho           | `eip155:8453`                                      | Yes               | None            |
